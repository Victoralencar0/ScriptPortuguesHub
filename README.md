...
function CheckQuest() 
    ...
    elseif Mundo3 then
        ...
        elseif MyLevel == 1650 or MyLevel <= 1699 then 
            ...
            NameQuest = "AmazonQuest2"
            LevelQuest = 2
            NameMon = "Giant Ilhaer"
            CFrameQuest = CFrame.new(5446.8793945313, 601.62945556641, 749.45672607422)
            CFrameMon = CFrame.new(4729.09423828125, 590.436767578125, -36.97627639770508)
        elseif MyLevel == 1700 or MyLevel <= 1724 then
            Mon = "Marine Commodore"
            LevelQuest = 1
            NameQuest = "MarineTreeIlha"
...
function UpdateIlhaESP() 
    for i,v in pairs(game:GetService("Workspace")["_MundoOrigin"].Locations:GetChildren()) do
        pcall(function()
            if IlhaESP then 
                if v.Name ~= "Sea" then
                    if not v:FindFirstChild('NameEsp') then
                        ...
                        name.TextCor3 = Cor3.fromRGB(7, 236, 240)
                    else
            ...
            if ESPPlayer then
                if not isnil(v.Character.Head) and not v.Character.Head:FindFirstChild('NameEsp'..Number) then
                    ...
                    if v.Team == game.Players.LocalPlayer.Team then
                        name.TextCor3 = Cor3.new(0,255,0)
                    else
                        name.TextCor3 = Cor3.new(255,0,0)
                    end
                else
                ...
                if string.find(v.Name,"Chest") then
                    if not v:FindFirstChild('NameEsp'..Number) then
                        ...
                        if v.Name == "Chest1" then
                            name.TextCor3 = Cor3.fromRGB(109, 109, 109)
                            name.Text = ("Chest 1" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                        if v.Name == "Chest2" then
                            name.TextCor3 = Cor3.fromRGB(173, 158, 21)
                            name.Text = ("Chest 2" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                        if v.Name == "Chest3" then
                            name.TextCor3 = Cor3.fromRGB(85, 255, 255)
                            name.Text = ("Chest 3" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        end
                    else
...
for i,v in pairs(game.Workspace:GetChildren()) do
    pcall(function()
        if DevilFrutaESP then
            if string.find(v.Name, "Fruta") then   
                if not v.Handle:FindFirstChild('NameEsp'..Number) then
                    ...
                    name.BackgroundTransparency = 1
                    name.TextStrokeTransparency = 0.5
                    name.TextCor3 = Cor3.fromRGB(255, 255, 255)
        ...
        if v.Name == "Flower2" or v.Name == "Flower1" then
            if FlowerESP then 
                if not v:FindFirstChild('NameEsp'..Number) then
                    ...
                    name.BackgroundTransparency = 1
                    name.TextStrokeTransparency = 0.5
                    name.TextCor3 = Cor3.fromRGB(255, 0, 0)
                    if v.Name == "Flower1" then 
                        name.Text = ("Blue Flower" ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Position).Magnitude/3) ..' Distance')
                        name.TextCor3 = Cor3.fromRGB(0, 0, 255)
                    end
...
function UpdateRealFrutaChams() 
for i,v in pairs(game.Workspace.AppleSpawner:GetChildren()) do
    if v:IsA("Tool") then
        if RealFrutaESP then 
            if not v.Handle:FindFirstChild('NameEsp'..Number) then
                local bill = Instance.new('BillboardGui',v.Handle)
                bill.Name = 'NameEsp'..Number
                bill.ExtentsOffset = Vector3.new(0, 1, 0)
    ...
    if v:IsA("Tool") then
        if RealFrutaESP then 
            if not v.Handle:FindFirstChild('NameEsp'..Number) then
                ...
                name.BackgroundTransparency = 1
                name.TextStrokeTransparency = 0.5
                name.TextCor3 = Cor3.fromRGB(255, 174, 0)
                name.Text = (v.Name ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            else
                v.Handle['NameEsp'..Number].TextLabel.Text = (v.Name ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            end
    ...
    if v:IsA("Tool") then
        if RealFrutaESP then 
            if not v.Handle:FindFirstChild('NameEsp'..Number) then
                ...
                name.BackgroundTransparency = 1
                name.TextStrokeTransparency = 0.5
                name.TextCor3 = Cor3.fromRGB(251, 255, 0)
                name.Text = (v.Name ..' \n'.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            else
                v.Handle['NameEsp'..Number].TextLabel.Text = (v.Name ..' '.. round((game:GetService('Players').LocalPlayer.Character.Head.Position - v.Handle.Position).Magnitude/3) ..' Distance')
            end
            ...
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    if not v:FindFirstChild("MobEap") then
                        ...
                        TextLabel.BackgroundCor3 = Cor3.fromRGB(255, 255, 255)
                        TextLabel.BackgroundTransparency = 1.000
                        TextLabel.Size = UDim2.new(0, 200, 0, 50)
                        TextLabel.Font = Enum.Font.GothamBold
                        TextLabel.TextCor3 = Cor3.fromRGB(7, 236, 240)
...
while wait() do
    pcall(function()
        if SeaESP then
            for i,v in pairs(game:GetService("Workspace").Fera do Mars:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
...
function UpdateIlhaMirageESP() 
for i,v in pairs(game:GetService("Workspace")["_MundoOrigin"].Locations:GetChildren()) do
    pcall(function()
        if MirageIlhaESP then 
            if v.Name == "Mirage Ilha" then
                if not v:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
                    ...
                    name.BackgroundTransparency = 1
                    name.TextStrokeTransparency = 0.5
                    name.TextCor3 = Cor3.fromRGB(80, 245, 245)
                else
...
for i,v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
    pcall(function()
        if AfdESP then 
            if v.Name == "Advanced Fruta Distribuidor" then
                if not v:FindFirstChild('NameEsp') then
                    local bill = Instance.new('BillboardGui',v)
                    bill.Name = 'NameEsp'
                    bill.ExtentsOffset = Vector3.new(0, 1, 0)
...
function InfAb()
    if InfAbility then
        if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.Cor = CorSequence.new(Cor3.fromRGB(0,0,0),Cor3.fromRGB(0,0,0))
...
spawn(function()
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_MundoOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("SlashHit") or v.Name == ("EspadaSlash") or v.Name == ("SlashTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
function Check_Espada(Espada_Name)
    for i, v in pairs(game:GetService("ReplicatedStorage").Remotes['CommF_']:InvokeServer("getInventory")) do
        if (v.Type == "Espada") then
            if v.Name == Espada_Name then
                return true
            end
        end
    end
...
task.spawn(function()
    while task.wait() do
        pcall(function()
            if _G.AutoFarmNearest and AutoFarmNearestMagnet or SelecionarMag and _G.BringMonster then
...
game:GetService("RunService").Heartbeat:Connect(function()
    if _G.AutoVampire or AutoFarmChest or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongEspada or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmarmaMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoAbrirSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFrutaMastery or _G.AutoFarmarmaMastery or _G.TeleportIlha or _G.Auto_EvoRaça or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruta or _G.AutoBudyEspada or _G.AutoOderEspada or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruta or _G.Auto_Mastery_arma or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.d or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or AutoFarmChest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.TweenFruta or _G.AutoKai or _G.TeleportNPC or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or armapowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIlha or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRaça or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or Grab_Chest or _G.Namfon or _G.AutoEspadaMastery or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.Farmfast or _G.AutoRaça or _G.RaidPirate then
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoVampire or AutoFarmChest or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongEspada or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmarmaMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoAbrirSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.AutoFarmFrutaMastery or _G.AutoFarmarmaMastery or _G.TeleportIlha or _G.Auto_EvoRaça or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruta or _G.AutoBudyEspada or _G.AutoOderEspada or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruta or _G.Auto_Mastery_arma or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or FarmBoss or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.d or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or AutoFarmChest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.TweenFruta or _G.TeleportNPC or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or armapowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIlha or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRaça or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or Grab_Chest or _G.Namfon or _G.AutoEspadaMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.Farmfast or _G.AutoRaça or _G.RaidPirate == true then
...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.AutoVampire or AutoFarmChest or _G.AutoAdvanceDungeon or _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFactory or _G.AutoFarmBossHallow or _G.AutoFarmSwanGlasses or _G.AutoLongEspada or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmarmaMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoAbrirSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFrutaMastery or _G.AutoFarmarmaMastery or _G.TeleportIlha or _G.Auto_EvoRaça or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruta or _G.AutoBudyEspada or _G.AutoOderEspada or _G.AutoBounty or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruta or _G.Auto_Mastery_arma or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.GrabChest or _G.AutoFarmBounty or _G.Holy_Torch or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.AutoFarmMaterial or _G.AutoNevaSoulGuitar or _G.Auto_Dragon_Trident or _G.Autotushita or _G.Autowaden or _G.Autogay or _G.Autopole or _G.Autosaw or _G.AutoObservationHakiV2 or _G.AutoFarmNearest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.TweenFruta or _G.TeleportNPC or _G.AutoKai or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or armapowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoMysticIlha or _G.AutoFarmDungeon or _G.AutoRaidPirate or _G.AutoQuestRaça or _G.TweenMGear or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or _G.Namfon or _G.AutoEspadaMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Position_Spawn or _G.TPB or _G.Farmfast or _G.AutoRaça or _G.RaidPirate == true then
...
spawn(function()
    while wait() do
        if _G.AutoDoughtBoss or _G.Auto_DungeonMobAura or _G.AutoFarmChest or _G.AutoFarmBossHallow or _G.AutoFactory or _G.AutoFarmSwanGlasses or _G.AutoLongEspada or _G.AutoBlackSpikeycoat or _G.AutoElectricClaw or _G.AutoFarmarmaMastery or _G.AutoHolyTorch or _G.AutoLawRaid or _G.AutoFarmBoss or _G.AutoTwinHooks or _G.AutoAbrirSwanDoor or _G.AutoDragon_Trident or _G.AutoSaber or _G.NOCLIP or _G.AutoFarmFrutaMastery or _G.AutoFarmarmaMastery or _G.TeleportIlha or _G.Auto_EvoRaça or _G.AutoFarmAllMsBypassType or _G.AutoObservationv2 or _G.AutoMusketeerHat or _G.AutoEctoplasm or _G.AutoRengoku or _G.Auto_Rainbow_Haki or _G.AutoObservation or _G.AutoDarkDagger or _G.Safe_Mode or _G.MasteryFruta or _G.AutoBudyEspada or _G.AutoOderEspada or _G.AutoAllBoss or _G.Auto_Bounty or _G.AutoSharkman or _G.Auto_Mastery_Fruta or _G.Auto_Mastery_arma or _G.Auto_Dungeon or _G.Auto_Cavender or _G.Auto_Pole or _G.Auto_Kill_Ply or _G.Auto_Factory or _G.AutoSecondSea or _G.TeleportPly or _G.AutoBartilo or _G.Auto_DarkBoss or _G.AutoFarm or _G.Clip or _G.AutoElitehunter or _G.AutoThirdSea or _G.Auto_Bone or _G.Autoheart or _G.Autodoughking or _G.d or _G.Autowaden or _G.Autogay or _G.AutoObservationHakiV2 or _G.AutoFarmMaterial or _G.AutoFarmNearest or _G.AutoCarvender or _G.AutoTwinHook or AutoMobAura or _G.Leather or _G.Auto_Wing or _G.Umm or _G.Makori_gay or Radioactive or Fish or armapowder or Dragon_Scale or Cocoafarm or Scrap or MiniHee or _G.AutoFarmSeabaest or Auto_Cursed_Dual_Katana or _G.AutoFarmMob or _G.AutoRaidPirate or getgenv().AutoFarm or _G.AutoPlayerHunter or _G.AutoFactory or _G.AttackDummy or _G.AutoEspadaMastery or _G.Auto_Seabest or _G.AutoSeaBest or _G.AutoKillTial or _G.Auto_Saber or _G.Farmfast or _G.RaidPirate == true then
            pcall(function()
...
spawn(
	...
	function IsMirageIlha2()
		if game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
			return true
		else
			return false
		end
...
function TweenTempleLegit()
		...
		if
			(TempleMysteriousNPC2.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <
				15
		 then
			game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaçaV4Progress", "TeleportBack")
		end
		if
			(TempleMysteriousNPC1.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <
				15
		 then
			game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaçaV4Progress", "Teleport")
         end
	end
	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIlha") then
			for r, v in pairs(game.workspace.Map.MysticIlha:GetChildren()) do
	...
	function getHighestPoint()
		if not game.workspace.Map:FindFirstChild("MysticIlha") then
			return nil
		end
		for r, v in pairs(game:GetService("Workspace").Map.MysticIlha:GetDescendants()) do
...
CamShake:Stop()
    ...
    local i = "Script Portugues Hub"
    local j = "-BloxFruta.json"
    ...
    function CheckAcientOneStatus()
        if not game.Players.LocalPlayer.Character:FindFirstChild("RaçaTransformed") then
            return "You have yet to achieve greatness"
        end
        local v227 = nil
        local v228 = nil
        local v229 = nil
        v229, v228, v227 = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("UpgradeRaça", "Check")
        if v229 == 1 then
            return "Treine mais"
        elseif v229 == 2 or v229 == 4 or v229 == 7 then
            return "Pode comprar equipamento com " .. v227 .. " Fragmentos"
        elseif v229 == 3 then
            return "Treine mais"
        elseif v229 == 5 then
            return "Você terminou sua Raça."
        elseif v229 == 6 then
            return "Upgrades Completod: " .. v228 - 2 .. "/3, Need Trains More"
        end
        if v229 ~= 8 then
            if v229 == 0 then
                return "Pronto para Trial"
            else
                return "You have yet to achieve greatness"
            end
        end
...
local Window = OrionLib:MakeWindow({Name = "Script Portugues Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Script Portugues Hub"})

OrionLib:MakeNotification({
	Name = "Script Portugues Hub",
...
W:AddLabel("[+] Script Portugues Hub Está aqui!")
...
local locallv = W:AddLabel("Level")
    ...
    local localRaça = W:AddLabel("Raça")
    
    spawn(function()
        while wait() do
            pcall(function()
                localRaça:Set("Raça :".." "..game:GetService("Players").LocalPlayer.Data.Raça.Value)
            end)
        end
    end)
    ...
    local localfrag = W:AddLabel("Fragmento")
    
    spawn(function()
        while wait() do
            pcall(function()
                localfrag:Set("Fragmentos :".." "..game:GetService("Players").LocalPlayer.Data.Fragmentos.Value)
            end)
        end
    end)
    ...
    local localstat = W:AddLabel("Status Points")
    
    spawn(function()
        while wait() do
            pcall(function()
                localstat:Set("Status Points :".." "..game:GetService("Players").LocalPlayer.Data.Points.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localbountyhornor:Set("Bounty / Honor :".." "..game:GetService("Players").LocalPlayer.leaderStatus["Bounty/Honor"].Value)
            end)
        end
    end)
    
    local localDevil = W:AddLabel("Fruta Do Diabo")
    
    spawn(function()
        while wait() do
            pcall(function()
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value) or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value) then
                    localDevil:Set("Fruta Do Diabo :".." "..game:GetService("Players").LocalPlayer.Data.DevilFruta.Value)
                else
                    localDevil:Set("Not Have Fruta Do Diabo")
                end
            end)
        end
    end)
    ...
    local WolrdSet3 = W:AddLabel("Mundo 1 ❌ ")
    local WolrdSet = W:AddLabel("Wolrd : 2 ❌")
    local WolrdSet1 = W:AddLabel("Wolrd : 3 ❌")
    local Section = W:AddSection({
        Name = "Status Point"
    })
    local StastSoco = W:AddLabel("")
    local Stastdefesa = W:AddLabel("")
    local StastEspada = W:AddLabel("")
    local Stastarma = W:AddLabel("")
    local StastDevilFruta = W:AddLabel("")
    ...
    local        BuddyEspada =        W:AddLabel("❌ : Buddy Espada")
...
local Section = M:AddSection({
    Name = "Selecionar Weapon"
})

M:AddParagraph("Selecionar Weapon","Please Selecionar Weapon")

local WeaponList = {"Soco","Espada","Fruta","arma"}
_G.SelecionarWeapon = "Soco"
M:AddDropdown({
    Name = "Selecionar Weapon",
    Default = "",
    Options = WeaponList,
    Flag = "Selecionar Weapon",
    Save = true,
    Callback = function(Value)
        _G.SelecionarWeapon = Value
    end    
})
task.spawn(function()
    while wait() do
        pcall(function()
            if _G.SelecionarWeapon == "Soco" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                    if v.ToolTip == "Soco" then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v.Name)) then
                            _G.SelecionarWeapon = v.Name
                        end
                    end
                end
            elseif _G.SelecionarWeapon == "Espada" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif _G.SelecionarWeapon == "arma" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            ...
            elseif _G.SelecionarWeapon == "Fruta" then
                for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
if Mundo2 and Mundo1 then
        ...
        Callback = function()
            pcall(function()
                ...
                for i, e in pairs(l:GetChildren()) do
                    if e:IsA("BlurEffect") or e:IsA("SunRaysEffect") or e:IsA("CorCorrectionEffect") or e:IsA("BloomEffect") or e:IsA("DepthOfFieldEffect") then
                        e.Enabled = false
                    end
                end
    ...
    M:AddParagraph("Redeem Code","Click to Button to Reddem All Code In Blox Frutas.")
...
M:AddToggle({
    ...
    Save = true,
    Callback = function(Value)
        _G.AutoFarmFrutaMastery = Value
        StopTween(_G.AutoFarmFrutaMastery)
        if _G.AutoFarmFrutaMastery == false then
            UseSkill = false 
        end
    end    
})
...
M:AddToggle({
    Name = "Auto Farm arma Mastery",
    Default = false,
    Flag = "arma Mastery",
    Save = true,
    Callback = function(Value)
        _G.AutoFarmarmaMastery = Value
        StopTween(_G.AutoFarmarmaMastery)
    end    
})
...
M:AddToggle({
    ...
    Callback = function(Value)
        ...
        _G.AutoFarm = Value
        _G.Farmfast = Value
       _G.SelecionarWeapon = "Combat"
       _G.AutoPlayerHunter = Value
       _G.Auto_Status_Kaitun = Value
       _G.Auto_Saber = Value
       _G.AutoSuperhuman = Value
       _G.AutoBartilo = Value
       _G.AutoBuyLegendaryEspada = Value
       _G.BuyAllAib = Value
       StopTween(_G.AutoFarm)
       StopTween(_G.Hunter)
       StopTween(_G.Farmfast)
...
if Mundo1 then
    ...
    M:AddDropdown({
        Name = "Selecionar Mobs",
        Default = "",
        Options = {"Pirate Millionaire","Dragon Crew Warrior","Dragon Crew Archer","Female Ilhaer","Giant Ilhaer","Marine Commodore","Marine Rear Admiral","Fishman Raider","Fishman Captain","Forest Pirate","Mythological Pirate","Jungle Pirate","Musketeer Pirate","Reborn Skeleton","Living Zombie","Demonic Soul","Posessed Mummy", "Peanut Scout", "Peanut President", "Ice Cream Chef", "Ice Cream Commander", "Cookie Crafter", "Cake Guard", "Baking Staff", "Head Baker", "Cocoa Warrior", "Chocolate Bar Battler", "Sweet Thief", "Candy Rebel", "Candy Pirate", "Snow Demon"},
        Callback = function(Value)
            SelecionarMonster = Value
        end    
    }) 
    ...
    M:AddToggle({
        ...
        Default = false,
        Callback = function(Value)
            _G.AutoFarmSelecionarMonster = Value
        end    
    }) 
...
IQ:AddToggle({
    Name = "Auto Buddy Espada",
    Default = false,
    Flag = "Auto Buddy",
    Save = true,
    Callback = function(Value)
        _G.AutoBudyEspada = Value
        StopTween(_G.AutoBudyEspada)
    end    
})

IQ:AddToggle({
    Name = "Auto Buddy Espada[HOP]",
    Default = false,
    Flag = "Auto Buddy[HOP]",
    Save = true,
    Callback = function(Value)
...
ToggleHallow = IQ:AddToggle({
        ...
        spawn(function()
            pcall(function()
                while wait() do
                    if (_G.AutoDarkDagger_Hop and _G.AutoDarkDagger) and Mundo3 and not game:GetService("ReplicatedStorage"):FindFirstChild("rip_indra True Form") and not game:GetService("Workspace").Enemies:FindFirstChild("rip_indra True Form") then
                        Hop()
                    end
                end
            end)
    ...
    IQ:AddToggle({
        Name = "Auto Fera do Mar",
        Default = false,
        Flag = "Auto Fera do Mar",
        Save = true,
        Callback = function(Value)
...
IQ:AddToggle({
    Name = "Auto Fera do Mar[HOP]",
    Default = false,
    Flag = "Auto Fera do Mar[HOP]",
    Save = true,
    Callback = function(Value)
        _G.Hop = Value
    end    
...
IQ:AddToggle({
    Name = "Auto Summon and Find Mirrage Ilha",
    Default = false,
    Flag = "Auto Mirrage",
    Save = true,
    Callback = function(Value)
        ...
        for _,v in next, workspace.Boats.PirateBrigade:GetDescendants() do
            ...
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.CFrame
             if game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
                                   topos(game:GetService("Workspace").Map:FindFirstChild("MysticIlha").HumanoidRootPart.CFrame * CFrame.new(0,500,-100))
...
spawn(function()
    while wait() do
        ...
        for i,v in pairs(game.Workspace:GetChildren()) do
            if v.Name == "Blox Fruta Distribuidor" then
            else
                if string.find(v.Name, "Fruta") and v:IsA("Tool") then
                    count = count + 1
                end
                if string.find(v.Name, "Fruta") and v:IsA("Model") then
                    count = count + 1
                end
            end
        end
        Fruta:Set("Fruta : "..count)
...
local Soco = S:AddLabel("Soco : ")
local defesa = S:AddLabel("defesa : ")
local Espada = S:AddLabel("Espada : ")
local arma = S:AddLabel("arma : ")
local Fruta = S:AddLabel("Fruta : ")

    spawn(function()
        while wait() do
            pcall(function()
                Soco:Set("Soco : "..game.Players.localPlayer.Data.Status.Soco.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                defesa:Set("defesa : "..game.Players.localPlayer.Data.Status.defesa.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Espada:Set("Espada : "..game.Players.localPlayer.Data.Status.Espada.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                arma:Set("arma : "..game.Players.localPlayer.Data.Status.arma.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Fruta:Set("Fruta : "..game.Players.localPlayer.Data.Status["Demon Fruta"].Level.Value)
            end)
        end
    end)

S:AddToggle({
    Name = "Auto Status Kaitun",
    Default = false,
    Flag = "Auto Kaitun",
    Save = true,
    Callback = function(Value)
...
local checkIlha = RA:AddLabel("Ilha : Not Raid")

_G.SelecionarChip = Selecionarraids or ""
    Raidslist = {}
    ...
    RA:AddDropdown({
        Name = "Selecionar Chips",
        Default = "",
        Options = Raidslist,
        Flag = "Selecionar Chips",
        Save = true,
        Callback = function(Value)
            _G.SelecionarChip = Value
        end    
    })
...
RA:AddButton({
    Name = "Buy Chips Selecionar",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Selecionar",_G.SelecionarChip)
      end    
})
...
LC:AddDropdown({
    ...
    "Shank Room",
    "Mob Ilha",},
    Flag = "Selecionar Ilha",
    Save = true,
    Callback = function(Value)
        _G.SelecionarIlha = Value
    end    
})
end
...
LC:AddToggle({
    Name = "Teleport To Ilha",
    Default = false,
    Callback = function(Value)
        _G.TeleportIlha = Value
        if _G.TeleportIlha == true then
            repeat wait()
                if _G.SelecionarIlha == "WindMill" then
                    topos(CFrame.new(979.79895019531, 16.516613006592, 1429.0466308594))
                elseif _G.SelecionarIlha == "Marine" then
                    topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
                elseif _G.SelecionarIlha == "Middle Town" then
                    topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                elseif _G.SelecionarIlha == "Jungle" then
                    topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
                elseif _G.SelecionarIlha == "Pirate Village" then
                    topos(CFrame.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
                elseif _G.SelecionarIlha == "Desert" then
                    topos(CFrame.new(944.15789794922, 20.919729232788, 4373.3002929688))
                elseif _G.SelecionarIlha == "Snow Ilha" then
                    topos(CFrame.new(1347.8067626953, 104.66806030273, -1319.7370605469))
                elseif _G.SelecionarIlha == "MarineFord" then
                    topos(CFrame.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
                elseif _G.SelecionarIlha == "Colosseum" then
                    topos( CFrame.new(-1427.6203613281, 7.2881078720093, -2792.7722167969))
                elseif _G.SelecionarIlha == "Sky Ilha 1" then
                    topos(CFrame.new(-4869.1025390625, 733.46051025391, -2667.0180664063))
                elseif _G.SelecionarIlha == "Sky Ilha 2" then  
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248, -1667.55688))
                elseif _G.SelecionarIlha == "Sky Ilha 3" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
                elseif _G.SelecionarIlha == "Prison" then
                    topos( CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
                elseif _G.SelecionarIlha == "Magma Village" then
                    topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
                elseif _G.SelecionarIlha == "Under Water Ilha" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
                elseif _G.SelecionarIlha == "Fountain City" then
                    topos(CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
                elseif _G.SelecionarIlha == "Shank Room" then
                    topos(CFrame.new(-1442.16553, 29.8788261, -28.3547478))
                elseif _G.SelecionarIlha == "Mob Ilha" then
                    topos(CFrame.new(-2850.20068, 7.39224768, 5354.99268))
                elseif _G.SelecionarIlha == "The Cafe" then
                    topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
                elseif _G.SelecionarIlha == "Frist Spot" then
                    topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
                elseif _G.SelecionarIlha == "Dark Area" then
                    topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
                elseif _G.SelecionarIlha == "Flamingo Mansion" then
                    topos(CFrame.new(-483.73370361328, 332.0383605957, 595.32708740234))
                elseif _G.SelecionarIlha == "Flamingo Room" then
                    topos(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
                elseif _G.SelecionarIlha == "Green Zone" then
                    topos( CFrame.new(-2448.5300292969, 73.016105651855, -3210.6306152344))
                elseif _G.SelecionarIlha == "Factory" then
                    topos(CFrame.new(424.12698364258, 211.16171264648, -427.54049682617))
                elseif _G.SelecionarIlha == "Colossuim" then
                    topos( CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
                elseif _G.SelecionarIlha == "Zombie Ilha" then
                    topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
                elseif _G.SelecionarIlha == "Two Snow Mountain" then
                    topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
                elseif _G.SelecionarIlha == "Punk Hazard" then
                    topos(CFrame.new(-6127.654296875, 15.951762199402, -5040.2861328125))
                elseif _G.SelecionarIlha == "Cursed Ship" then
                    topos(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
                elseif _G.SelecionarIlha == "Ice Castle" then
                    topos(CFrame.new(6148.4116210938, 294.38687133789, -6741.1166992188))
                elseif _G.SelecionarIlha == "Forgotten Ilha" then
                    topos(CFrame.new(-3032.7641601563, 317.89672851563, -10075.373046875))
                elseif _G.SelecionarIlha == "Ussop Ilha" then
                    topos(CFrame.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
                elseif _G.SelecionarIlha == "Mini Sky Ilha" then
                    topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
                elseif _G.SelecionarIlha == "Great Tree" then
                    topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
                elseif _G.SelecionarIlha == "Castle On The Sea" then
                ...
                elseif _G.SelecionarIlha == "MiniSky" then
                    topos(CFrame.new(-260.65557861328, 49325.8046875, -35253.5703125))
                elseif _G.SelecionarIlha == "Port Town" then
                    topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
                elseif _G.SelecionarIlha == "Hydra Ilha" then
                    topos(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
                elseif _G.SelecionarIlha == "Floating Turtle" then
                    topos(CFrame.new(-13274.528320313, 531.82073974609, -7579.22265625))
                elseif _G.SelecionarIlha == "Mansion" then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
                elseif _G.SelecionarIlha == "Haunted Castle" then
                    topos(CFrame.new(-9515.3720703125, 164.00624084473, 5786.0610351562))
                elseif _G.SelecionarIlha == "Ice Cream Ilha" then
                    topos(CFrame.new(-902.56817626953, 79.93204498291, -10988.84765625))
                elseif _G.SelecionarIlha == "Peanut Ilha" then
                    topos(CFrame.new(-2062.7475585938, 50.473892211914, -10232.568359375))
                elseif _G.SelecionarIlha == "Cake Ilha" then
                    topos(CFrame.new(-1884.7747802734375, 19.327526092529297, -11666.8974609375))
                elseif _G.SelecionarIlha == "Cocoa Ilha" then
                    topos(CFrame.new(87.94276428222656, 73.55451202392578, -12319.46484375))
                elseif _G.SelecionarIlha == "Candy Ilha New⛄" then
                    topos(CFrame.new(-1014.4241943359375, 149.11068725585938, -14555.962890625))
                elseif _G.SelecionarIlha == "Tiki Outpost New" then
                ...
                _G.TeleportIlha = false
                StopTween(_G.TeleportIlha)
            end
            until not _G.TeleportIlha
        end
        StopTween(_G.TeleportIlha)
    end    
})
...
NPC1 = {
            "Random Fruta Do Diabo",
            "Blox Frutas Distribuidor",
            "Remove Fruta Do Diabo",
            "Ability Teacher",
            "Dark Step", 
            "Electro",
            "Fishman Karate"
...
if Mundo2 then
    ...
    if Mundo3 then
        ...
        if _G.TeleportNPC == true then
            repeat wait()
                if _G.SelecionarNPC == "Dargon Berath" then
                    topos(CFrame.new(703.372986, 186.985519, 654.522034, 1, 0, 0, 0, 1, 0, 0, 0, 1))
                elseif _G.SelecionarNPC == "Mtsterious Man" then
                ...
                elseif _G.SelecionarNPC == "Mysterious Scientist" then
                ...
                elseif _G.SelecionarNPC == "Awakening Expert" then
                ...
                elseif _G.SelecionarNPC == "El Admin" then
                ...
                elseif _G.SelecionarNPC == "El Rodolfo" then
                ...
                elseif _G.SelecionarNPC == "Arowe" then
                ...
                elseif _G.SelecionarNPC == "Random Fruta Do Diabo" then
                ...
                elseif _G.SelecionarNPC == "Remove Fruta Do Diabo" then
                    topos(CFrame.new(5664.80469, 64.677681, 867.85907, 1, 0, 0, 0, 1, 0, 0, 0, 1))
                elseif _G.SelecionarNPC == "Ability Teacher" then
                ...
                elseif _G.SelecionarNPC == "Horned Man" then
                    topos(CFrame.new(-11890, 931, -8760))
                elseif _G.SelecionarNPC == "Hungey Man" then
                    topos(CFrame.new(-10919, 624, -10268))
                elseif _G.SelecionarNPC == "Previous Hero" then
                    topos(CFrame.new(-10368, 332, -10128))
                elseif _G.SelecionarNPC == "Butler" then
                    topos(CFrame.new(-5125, 316, -3130))
                elseif _G.SelecionarNPC == "Lunoven" then
                    topos(CFrame.new(-5117, 316, -3093))
                elseif _G.SelecionarNPC == "Elite Hunter" then
                    topos(CFrame.new(-5420, 314, -2828))
                elseif _G.SelecionarNPC == "Player Hunter" then
                    topos(CFrame.new(-5559, 314, -2840))
                elseif _G.SelecionarNPC == "Uzoth" then
                    topos(CFrame.new(-9785, 852, 6667))
                elseif _G.SelecionarNPC == "Spy" then
                ...
                elseif _G.SelecionarNPC == "Beast Hunter" then
                ...
                elseif _G.SelecionarNPC == "Shafi" then
        ...
        local Section = LC:AddSection({
            Name = "Teleport SeFera do Mar"
        })

LC:AddToggle({
    Name = "Teleport to Fera do Mar",
    Default = false,
    Flag = "Teleport to Fera do Mar",
    Save = true,
    Callback = function(Value)
        for i,v in pairs(game:GetService("Workspace").Fera do Mars:GetChildren()) do
            if v:FindFirstChild("HumanoidRootPart") then
...
LC:AddToggle({
    Name = "Teleport To Mirage Ilha",
    Default = false,
    Flag = "Teleport to Mirage",
    Save = true,
    Callback = function(Value)
        _G.AutoMysticIlha = Value
        StopTween(_G.AutoMysticIlha)
    end    
})
...
local SelecionaredPly = LC:AddDropdown({
    Name = "Selecionar Players",
    Default = "",
    Options = Playerslist,
    Callback = function(Value)
        _G.SelecionarPly = Value
    end    
})
...
LC:AddButton({
    ...
    SelecionaredPly:Refresh(NewPlayerList)
      end     
})
    ...
    Callback = function(Value)
        ...
        pcall(function()
            if _G.TeleportPly then
                repeat topos(game:GetService("Players")[_G.SelecionarPly].Character.HumanoidRootPart.CFrame) wait() until _G.TeleportPly == false
            end
...
local Elite_Hunter_Status = SV:AddLabel("Only Third Sea")
      ...
      if Mundo3 then
        spawn(function()
            pcall(function()
                while wait() do
        if game.Workspace._MundoOrigin.Locations:FindFirstChild('Mirage Ilha') then
...
D:AddToggle({
    Name = "Auto Random Frutas",
    Default = false,
    Flag = "Auto Random Frutas",
    Save = true,
    Callback = function(Value)
...
D:AddToggle({
    Name = "Auto Store Frutas",
    Default = false,
    Flag = "Auto Store Frutas",
    Save = true,
    Callback = function(Value)
        _G.AutoStoreFruta = Value
    end    
})
function DropFruta()
    pcall(function()
        game.Players.LocalPlayer.PlayerGui.Main.FrutaInventory.Position = UDim2.new(10.100, 0, 0.100, 0) -- HideUi
        game.Players.LocalPlayer.PlayerGui.Main.FrutaInventory.Visible = true -- เปิดไว้ถึงจะเช็คได้
        local invenFruta = game.Players.LocalPlayer.PlayerGui.Main.FrutaInventory.Container.Stored.ScrollingFrame.Frame
        wait(.3)
        for i,v in pairs(invenFruta:GetChildren()) do
            if string.find(v.Name,"-") then
                for _,Backpack in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    FrutaStoreF = string.split(Backpack.Name, " ")[1]
                    FrutaStoreR = FrutaStoreF.."-"..FrutaStoreF
                    if v.Name == FrutaStoreR then
        ...
        for i,v in pairs(invenFruta:GetChildren()) do
            if string.find(v.Name,"-") then
                for _,Character in pairs(game:GetService("Players").LocalPlayer.Character:GetChildren()) do
                    FrutaStoreF = string.split(Character.Name, " ")[1]
                    FrutaStoreR = FrutaStoreF.."-"..FrutaStoreF
                    if v.Name == FrutaStoreR then
...
D:AddToggle({
    Name = "Teleport To Fruta Spawn",
    Default = false,
    Flag = "Teleport To Fruta Spawn",
    Save = true,
    Callback = function(Value)
        _G.TweenFruta = Value
        StopTween(_G.TweenFruta)
    end    
})
spawn(function()
    while wait(.1) do
        if _G.TweenFruta then
            for i,v in pairs(game.Workspace:GetChildren()) do
                if string.find(v.Name, "Fruta") then
...
D:AddToggle({
    Name = "Auto Drop Fruta",
    Default = false,
    Flag = "Auto Drop Fruta",
    Save = true,
    Callback = function(Value)
        _G.DropFruta = Value
    end    
            ...
            pcall(function()
                for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
                    if string.find(v.Name, "Fruta") then
                        ...
                        EquipWeapon(v.Name)
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(SelecionarFruta).EatRemote:InvokeServer("Drop")
                    end
                end
...
D:AddToggle({
    Name = "Bring All Fruta[75% Kick]",
    Default = false,
    Flag = "Bring All Fruta[75% Kick]",
    Save = true,
    Callback = function(Value)
        _G.BringFrutaBF = Value
    end    
})
spawn(function()
    while wait() do
        if _G.BringFrutaBF then
            pcall(function()
                for i,v in pairs(game.Workspace:GetChildren()) do
                    if v:IsA("Tool") then
...
R:AddToggle({
    Name = "Auto Turn On Raça v3",
    Default = false,
    Flag = "Auto Turn On Raça v3",
    Save = true,
    Callback = function(Value)
        _G.V3 = Value
    end    
...
R:AddToggle({
    Name = "Auto Turn On Raça v4",
    Default = false,
    Flag = "Auto Turn On Raça v4",
    Save = true,
    Callback = function(Value)
        _G.V4 = Value
    end    
...
R:AddToggle({
    Name = "Auto Train Raça",
    Default = false,
    Flag = "Auto Train Raça",
    Save = true,
    Callback = function(Value)
    _G.AutoRaça = Value
    StardFarm = Value
    StopTween(StardFarm)
    StopTween(_G.AutoRaça)
    end    
})
...
R:AddButton({
  ...
  wait(.1)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
                if game:GetService("Players").LocalPlayer.Data.Raça.Value == "Homem-peixe" then
                wait(1)
                topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Humano" then
                wait(1)
                topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Ciborgue" then
                wait(1)
                topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Skypiea" then
                wait(1)
                topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Ghoul" then
                wait(1)
                topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Mink" then
                wait(1)
...
R:AddToggle({
    Name = "Auto Completo Trials",
    Default = false,
    Flag = "Auto Completo Trials",
    Save = true,
    Callback = function(Value)
        _G.AutoQuestRaça = Value
        StopTween(_G.AutoQuestRaça)
    end    
})

R:AddToggle({
    Name = "Matar jogadores automaticamente após testes",
    Default = false,
    Flag = "KillTrials",
    Save = true,
    Callback = function(Value)
...
SH:AddButton({
    Name = "Pole v.2 [ 5,000 Fragmentos ]",
    Callback = function()
...
SH:AddButton({
    Name = "Refund Status[2,500 Fragmento]",
    Callback = function()
...
SH:AddButton({
    Name = "Raça Random[3,000 Fragmento]",
    Callback = function()
...
C:AddButton({
    Name = "Abrir Loja de Frutas Do Diabo",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFrutas")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FrutaLoja.Visible = true	
      end    
})

C:AddButton({
    Name = "Abrir Inventory[Old]",
    Callback = function()
...
C:AddButton({
    Name = "Cor Haki",
    Callback = function()
        game.Players.localPlayer.PlayerGui.Main.Cors.Visible = true
      end    
})

C:AddToggle({
    Name = "Buy Haki Cor(Random)",
    Default = false,
    Callback = function(Value)
...
spawn(function()
    while wait() do
        if _G.AutoBuyEnchancementColour then
            ...
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
            if _G.AutoBuyEnchancementColour_Hop and _G.AutoBuyEnchancementColour and not Mundo1 then
                wait(10)
                Hop()
            end
        end 
                            ...
                            if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                                if v.Name == Mon then
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                        repeat task.wait()
                                            EquipWeapon(_G.SelecionarWeapon)
                                            AutoHaki()                                            
...
spawn(function()
    while wait() do
        if _G.AutoFarmFrutaMastery then
            pcall(function()
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                if not string.find(QuestTitle, NameMon) then
                    Magnet = false
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                    StartMasteryFrutaMagnet = false
                    UseSkill = false
                    CheckQuest()
                    repeat wait()
                        TP1(CFrameQuest)
                    until (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 or not _G.AutoFarmFrutaMastery
                                    ...
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                        ...
                                        repeat task.wait()
                                            if v.Humanoid.Health <= HealthMs then
                                                AutoHaki()
                                                EquipWeapon(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value)
                                                TP1(v.HumanoidRootPart.CFrame * CFrame.new(0,20,0))
                                                v.HumanoidRootPart.CanCollide = false
                                                PosMonMasteryFruta = v.HumanoidRootPart.CFrame
                                                v.Humanoid.WalkSpeed = 0
                                                v.Head.CanCollide = false
                                                UseSkill = true
                                            else           
                                            ...
                                            StartMasteryFrutaMagnet = true
                                            game:GetService'VirtualUser':CaptureController()
                                            game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                        until not _G.AutoFarmFrutaMastery or v.Humanoid.Health <= 0 or not v.Parent or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    else
                                        UseSkill = false
                                        StartMasteryFrutaMagnet = false
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    while wait() do
        if UseSkill then
            pcall(function()
                CheckQuest()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value) then
                        MasBF = game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Data.DevilFruta.Value].Level.Value
                    elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value) then
                        MasBF = game:GetService("Players").LocalPlayer.Backpack[game:GetService("Players").LocalPlayer.Data.DevilFruta.Value].Level.Value
                    end
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon-Dragon") then                      
                        if _G.SkillZ then
                            local args = {
                                [1] = PosMonMasteryFruta.Position
                            }
                    ...
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruta.Value) then
                        if _G.SkillZ then 
                            local args = {
                                [1] = PosMonMasteryFruta.Position
                            }
    ...
    pcall(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            if UseSkill then
                ...
                game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.Data.DevilFruta.Value].RemoteEvent:FireServer(unpack(args))
            end
        end)
    end)
end)
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoFarmarmaMastery then
                local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
                if not string.find(QuestTitle, NameMon) then
                    Magnet = false                                      
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                    ...
                                    repeat task.wait()
                                        if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                            ...
                                            if v.Humanoid.Health <= HealthMin then                                                
                                                EquipWeapon(SelecionarWeaponarma)
                                                ...
                                                game:GetService("Players").LocalPlayer.Character[SelecionarWeaponarma].RemoteFunctionShoot:InvokeServer(unpack(args))
                                            else
                                                AutoHaki()
                                                EquipWeapon(_G.SelecionarWeapon)
                                                v.Humanoid.WalkSpeed = 0
                                            ...
                                            StartMasteryarmaMagnet = true 
                                            PosMonMasteryarma = v.HumanoidRootPart.CFrame
                                        else
                                            StartMasteryarmaMagnet = false
                                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
                                        end
                                    until v.Humanoid.Health <= 0 or _G.AutoFarmarmaMastery == false or game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                    StartMasteryarmaMagnet = false
                                end
                            end
                        end)
        ...
        while wait() do 
            if _G.AutoSuperhuman then
                ...
                if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") then
                    _G.SelecionarWeapon = "Superhuman"
                end  
                if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") then
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value <= 299 then
                        _G.SelecionarWeapon = "Black Leg"
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value <= 299 then
                        _G.SelecionarWeapon = "Electro"
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value <= 299 then
                        _G.SelecionarWeapon = "Fishman Karate"
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw").Level.Value <= 299 then
                        _G.SelecionarWeapon = "Dragon Claw"
                    end
                    ...
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 300 and game:GetService("Players")["Localplayer"].Data.Fragmentos.Value >= 1500 then
                        UnEquipWeapon("Fishman Karate")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2") 
                    end
                    if game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 300 and game:GetService("Players")["Localplayer"].Data.Fragmentos.Value >= 1500 then
                        UnEquipWeapon("Fishman Karate")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2") 
...
spawn(function()
    while wait() do
        if _G.AutoSecondSea then
            pcall(function()
                if game.Players.LocalPlayer.Data.Level.Value >= 700 and Mundo1 then
                    _G.AutoFarm = false
        ...
        pcall(function()
            if _G.BringMonster then
                ...
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    ...
                    if _G.Auto_EvoRaça and StartEvoMagnet then
                    ...
                    if _G.AutoFarmFrutaMastery and StartMasteryFrutaMagnet then
                        if v.Name == "Monkey" then
                            if (v.HumanoidRootPart.Position - PosMonMasteryFruta.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CFrame = PosMonMasteryFruta
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
                    ...
                    if _G.AutoFarmarmaMastery and StartMasteryarmaMagnet then
                        if v.Name == "Monkey" then
                            if (v.HumanoidRootPart.Position - PosMonMasteryarma.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CFrame = PosMonMasteryarma
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
                    ...
                    if _G.AutoDoughtBoss and MagnetDought then
                        if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (v.HumanoidRootPart.Position - PosMonDoughtAbrirDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                            v.Humanoid:ChangeState(14)
                            v.HumanoidRootPart.CanCollide = false
                            v.Head.CanCollide = false
                            v.HumanoidRootPart.CFrame = PosMonDoughtAbrirDoor
                            if v.Humanoid:FindFirstChild("Animator") then
                                v.Humanoid.Animator:Destroy()
                            end
                            sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
                        ...
                        if StardFarm and FarmMag then
                            if (v.Name == "Sweet Thief" or v.Name == "Candy Rebel" or v.Name == "Cocoa Warrior" or v.Name == "Chocolate Bar Battler") and (v.HumanoidRootPart.Position - PosMonDoughtAbrirDoor.Position).Magnitude <= _G.BringMode and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.Farmfast and Mundo1 then
...
spawn(function()
    while wait(.1) do
    if _G.AutoFarmSelecionarMonster then
    pcall(function()
     CheckQuest(SelecionarMonster)
     if game:GetService("Workspace").Enemies:FindFirstChild(SelecionarMonster) then
     for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
     if v.Name == SelecionarMonster then
     ...
     PosMonSelecionarMonster = v.HumanoidRootPart.CFrame
     SelecionarMonsterMagnet = true
     until not _G.AutoFarmSelecionarMonster or not v.Parent or v.Humanoid.Health == 0 or not game:GetService("Workspace").Enemies:FindFirstChild(v.Name)
     end
     end
     end
     end
   ...
   spawn(function()
    ...
    spawn(function()
        ...
        spawn(function()
            while wait() do
            pcall(function()
             if _G.AutoFactory and Mundo2 then
            ...
            spawn(function()
                ...
                spawn(function()
                    while wait() do
                        if _G.AutoBuyLegendaryEspada then
                            pcall(function()
                                local args = {
                                    [1] = "LegendaryEspadaDistribuidor",
                                    [2] = "1"
                                }
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                local args = {
                                ...
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                                if _G.AutoBuyLegendaryEspada_Hop and _G.AutoBuyLegendaryEspada and Mundo2 then
                                    wait(10)
                                    Hop()
                                end
                            end)
                ...
                spawn(function()
                    while wait() do
                        if game.Players.localPlayer.Data.Points.Value >= PointStatus then
                            if Soco then
                                local args = {
                                    [1] = "AddPoint",
                                    [2] = "Soco",
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._MundoOrigin.Locations:FindFirstChild('Ilha 1') then
                checkIlha:Set(' Ilha : 1')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._MundoOrigin.Locations:FindFirstChild('Ilha 2') then
                checkIlha:Set('Ilha : 2')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._MundoOrigin.Locations:FindFirstChild('Ilha 3') then
                checkIlha:Set('Ilha : 3')
                        end
                    end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._MundoOrigin.Locations:FindFirstChild('Ilha 4') then
                checkIlha:Set('Ilha : 4')
                end
                end
                    end)
                end)
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                if game.Workspace._MundoOrigin.Locations:FindFirstChild('Ilha 5') then
                checkIlha:Set('Ilha : 5')
                        end
                    end
                    end)
                end)
                        ...
                        while wait() do
                            if _G.AutoBuyChip then
                                if not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                    if not game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 1") then
                                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc", "Selecionar", _G.SelecionarChip)
                                    end
                                end
                            end
                        ...
                        pcall(function()
                            if _G.Auto_StartRaid then
                                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
                                    if not game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 1") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Special Microchip") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Special Microchip") then
                                        if Mundo2 then
                                            fireclickdetector(game:GetService("Workspace").Map.CircleIlha.RaidSummon2.Button.Main.ClickDetector)
                                        elseif Mundo3 then
                        ...
                        pcall(function()
                            while wait() do
                                if _G.Auto_Dungeon then
                                    if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                                        if game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 5") then
                                            topos(game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 5").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 4") then
                                            topos(game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 4").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 3") then
                                            topos(game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 3").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 2") then
                                            topos(game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 2").CFrame*RaidPos)
                                        elseif game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 1") then
                                            topos(game:GetService("Workspace")["_MundoOrigin"].Locations:FindFirstChild("Ilha 1").CFrame*RaidPos)
                                        end
                                    end
                                end
                            end
                        ...
                        if _G.Auto_Start_Law_Dungeon then
                            pcall(function()
                                if game:GetService("Players").LocalPlayer.Character:FindFirstChild("Microchip") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Microchip") then
                                    fireclickdetector(game:GetService("Workspace").Map.CircleIlha.RaidSummon.Button.Main.ClickDetector)
                                end
                            end)
                        end
                    end
                ...
                spawn(function()
                    pcall(function()
                        while wait() do
                            if _G.AutoMysticIlha then
                                    repeat
                                        wait()
                                    until game:GetService("Workspace").Map:FindFirstChild("MysticIlha")
                                    if game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
                                        AllNPCS = getnilinstances()
                                        for r, v in pairs(game:GetService("Workspace").NPCs:GetChildren()) do
                                            table.insert(AllNPCS, v)
                ...
                spawn(function()
                    pcall(function()
                        while wait(.1) do
                            if _G.AutoStoreFruta then
                                for i,v in pairs(FrutaList) do
    ...
    pcall(function()
        while wait() do
            if _G.TweenMGear then
                if game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
                    for i,v in pairs(game:GetService("Workspace").Map.MysticIlha:GetChildren()) do 
                        if v:IsA("MeshPart")then 
...
spawn(function()
    while wait() do 
      local boneframe = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
        if _G.Auto_Bone and Mundo3 then
            pcall(function()
                  if BypassTP then
...
spawn(function()
    while wait() do
        if _G.AutoElitehunter and Mundo3 then
            pcall(function()
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Script Portugues Hub(Noitification)",
                                    ...
                                    if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
                                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                            repeat task.wait()
                                                ...
                                                v.HumanoidRootPart.Size = Vector3.new(80,80,80)
                                                MagnetDought = true
                                                PosMonDoughtAbrirDoor = v.HumanoidRootPart.CFrame
                                                topos(v.HumanoidRootPart.CFrame * Pos)
                                                game:GetService("VirtualUser"):CaptureController()
                                                game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
...
spawn(function()
    while wait() do
        if  _G.Autodoughking and Mundo3 then
            pcall(function()
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    ...
                    elseif Mundo3 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Giant Ilhaer") then
                            if game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") then
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Ilhaer").HumanoidRootPart.CFrame * CFrame.new(3,0,0)
                                until _G.AutoObservation == false or not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel")
                            else
                                repeat task.wait()
                                    game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = game:GetService("Workspace").Enemies:FindFirstChild("Giant Ilhaer").HumanoidRootPart.CFrame * CFrame.new(0,50,0)
                                    wait(1)
                                    if not game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui:FindFirstChild("ImageLabel") and _G.AutoObservation_Hop == true then
                                        game:GetService("TeleportService"):Teleport(game.PlaceId,game:GetService("Players").LocalPlayer)
                                    end
...
spawn(function()
        while wait() do
            if _G.AutoVampire and Mundo2 then
                pcall(function()
        ...
        if _G.AutoDeathStep then
            if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 450 then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
                    _G.SelecionarWeapon = "Death Step"
                end  
...
local MyFragmento = game.Players.LocalPlayer.Data.Fragmentos.Value
local Mybeli = game.Players.LocalPlayer.Data.Beli.Value
spawn(function()
    while wait() do
    if _G.AutoSharkman then
        if Mybeli <= 2500000 or MyFragmento <= 5000 then
            wait(2.0)
            OrionLib:MakeNotification({
                Name = "Script Portugues Hub",
                Content = "You not have beli or Fragmento!",
                Image = "rbxassetid://119980140458596",
                Time = 5
            })
            end
            ...
            if _G.AutoElectricClaw then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electro") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Electric Claw") then
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 400 then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
                        _G.SelecionarWeapon = "Electric Claw"
                    end  
        ...
        if _G.AutoDragonTalon then
            if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw").Level.Value >= 400 then
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon")
                    _G.SelecionarWeapon = "Dragon Talon"
                end  
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.Auto_Saber and game.Players.LocalPlayer.Data.Level.Value >= 200 and not Check_Espada("Saber") and Mundo1 then
                ToggleFarm:Set(false)
                _G.Auto_Saber = true
            end
        end)
...
spawn(function()
while wait() do
    if _G.Autopole and Mundo1 then
        pcall(function()
    ...
    spawn(function()
        while wait() do
            if _G.AutoThirdSea then
                pcall(function()
                    if game:GetService("Players").LocalPlayer.Data.Level.Value >= 1500 and Mundo2 then
                        _G.AutoFarm = false
...
local BigMomPos = CFrame.new(-731.2034301757812, 381.5658874511719, -11198.4951171875)
    spawn(function()
        while wait() do
            if _G.AutoBudyEspada and Mundo3 then
                pcall(function()
                            ...
                            if v.Name == "Cake Queen" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                    repeat task.wait()
                                        ...
                                        game:GetService("VirtualUser"):Button1Down(Vector2.new(1280,672))
                                        sethiddenproperty(game.Players.LocalPlayer,"SimulationRadius",math.huge)
                                    until not _G.AutoBudyEspada or not v.Parent or v.Humanoid.Health <= 0
                                end
                            end
                        end
                    else
                            ...
                            if game:GetService("Workspace").NPCs:FindFirstChild("Skeleton Machine") then
                                ...
                                if game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency == 0 then
                                    ...
                                    elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
                                        if game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part1:FindFirstChild("ClickDetector") then
                                            Quest4 = true
                                            ...
                                            wait(1)
                                            topos(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part3.CFrame)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part3.ClickDetector)
                                            wait(1)
                                            topos(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part4.CFrame)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part4.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part4.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part4.ClickDetector)
                                            wait(1)
                                            topos(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part6.CFrame)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part6.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part6.ClickDetector)
                                            wait(1)
                                            topos(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part8.CFrame)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part8.ClickDetector)
                                            wait(1)
                                            topos(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part10.CFrame)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part10.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part10.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].CorFloor.Model.Part10.ClickDetector)
    ...
    while wait() do
        if _G.AutoObservationHakiV2 then
            ...
            if game.Players.LocalPlayer.Backpack:FindFirstChild("Banana") and  game.Players.LocalPlayer.Backpack:FindFirstChild("Apple") and game.Players.LocalPlayer.Backpack:FindFirstChild("Pineapple") then
                ...
                wait(.5)
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress","Citizen")
            elseif game.Players.LocalPlayer.Backpack:FindFirstChild("Fruta Bowl") or game.Players.LocalPlayer.Character:FindFirstChild("Fruta Bowl") then
                repeat 
...
spawn(function()
    while wait() do
        pcall(function()
            if Auto_Cursed_Dual_Katana then
                if GetMaterial("Alucard Fragmento") == 0 then
                ...
                elseif GetMaterial("Alucard Fragmento") == 1 then
                    ...
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Evil")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Evil")
                elseif GetMaterial("Alucard Fragmento") == 2 then
                    Auto_Quest_Yama_1 = false
                    Auto_Quest_Yama_2 = false
                    ...
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Evil")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Evil")
                elseif GetMaterial("Alucard Fragmento") == 3 then
                    Auto_Quest_Yama_1 = false
                    Auto_Quest_Yama_2 = false
                    Auto_Quest_Yama_3 = false
                ...
                elseif GetMaterial("Alucard Fragmento") == 4 then
                    Auto_Quest_Yama_1 = false
                    Auto_Quest_Yama_2 = false
                    Auto_Quest_Yama_3 = false
                    Auto_Quest_Tushita_1 = false
                    ...
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Good")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Good")
                elseif GetMaterial("Alucard Fragmento") == 5 then
                    Auto_Quest_Yama_1 = false
                    Auto_Quest_Yama_2 = false
                    Auto_Quest_Yama_3 = false
                    Auto_Quest_Tushita_1 = false
                    ...
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Good")
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Good")
                elseif GetMaterial("Alucard Fragmento") == 6 then
        ...
        if Auto_Quest_Yama_3 then
            pcall(function()
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HellDimension") then
                    ...
                    until Auto_Cursed_Dual_Katana == false or Auto_Quest_Yama_3 == false or GetMaterial("Alucard Fragmento") == 3
                else
        ...
        if Auto_Quest_Tushita_3 then
            pcall(function()
                ...
                elseif game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension") then
                    ...
                    until not Auto_Cursed_Dual_Katana or not Auto_Quest_Tushita_3 or GetMaterial("Alucard Fragmento") == 6
                end
            end)
        end
    end
...
local TushitaPos = CFrame.new(-10238.875976563, 389.7912902832, -9549.7939453125)
    spawn(function()
        while wait() do
            if  _G.Autotushita and Mundo3 then
                pcall(function()
    ...
    spawn(function()
        while wait() do
            if  _G.AutoCarvender and Mundo3 then
                pcall(function()
    ...
    spawn(function()
        while wait() do
            if  _G.AutoTwinHook and Mundo3 then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Captain Elephant" then
    ...
    spawn(function()
        while wait() do 
          local boneframe = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
            if _G.Auto_Bone2 and Mundo3 then
                pcall(function()
                      if BypassTP then
                      if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - boneframe.Position).Magnitude > 2000 then
                      BTP(boneframe)
    ...
    while wait() do
        pcall(function()
            if _G.Auto_Seabest then
                if not game:GetService("Workspace").Fera do Mars:FindFirstChild("Fera do Mar1") then
                        ...
                        if not game:GetService("Workspace").Boats:FindFirstChild("PirateBasic") then
                            ...
                            elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                                ...
                                elseif game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit == true then
                                    ...
                                    until game:GetService("Workspace").Fera do Mars:FindFirstChild("Fera do Mar1") or _G.Auto_Seabest == false
                                end
                            end
                        elseif game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                ...
                elseif game:GetService("Workspace").Fera do Mars:FindFirstChild("Fera do Mar1") then  
                    for i,v in pairs(game:GetService("Workspace").Fera do Mars:GetChildren()) do
                        if v:FindFirstChild("HumanoidRootPart") then
                            repeat wait()
                                game.Players.LocalPlayer.Character:WaitForChild("Humanoid").Sit = false
...
spawn(function()
    while wait() do
        if _G.Auto_Kill_Ply then
            pcall(function()
                if _G.SelecionarPly ~= nil then 
                    if game.Players:FindFirstChild(_G.SelecionarPly) then
                        if game.Players:FindFirstChild(_G.SelecionarPly).Character.Humanoid.Health > 0 then
                            repeat task.wait()
                                EquipWeapon(_G.SelecionarWeapon)
                                AutoHaki()
                                game.Players:FindFirstChild(_G.SelecionarPly).Character.HumanoidRootPart.CanCollide = false
                                topos(game.Players:FindFirstChild(_G.SelecionarPly).Character.HumanoidRootPart.CFrame * CFrame.new(0,5,0))
                                spawn(function()
                                    pcall(function()
                                        if _G.SelecionarWeapon == SelecionarWeaponarma then
                                            local args = {
                                                [1] = game.Players:FindFirstChild(_G.SelecionarPly).Character.HumanoidRootPart.Position,
                                                [2] = game.Players:FindFirstChild(_G.SelecionarPly).Character.HumanoidRootPart
                                            }
                                            game:GetService("Players").LocalPlayer.Character[SelecionarWeaponarma].RemoteFunctionShoot:InvokeServer(unpack(args))
                                        else
                                            game:GetService("VirtualUser"):CaptureController()
                            ...
                            until game.Players:FindFirstChild(_G.SelecionarPly).Character.Humanoid.Health <= 0 or not game.Players:FindFirstChild(_G.SelecionarPly) or not _G.Auto_Kill_Ply
                        else 
                            if game.Players.LocalPlayer.Character.Humanoid.Health <= 3000 then
                                topos(game.Players:FindFirstChild(_G.SelecionarPly).Character.HumanoidRootPart.CFrame * CFrame.new(0,30,0))
                            end
                        end
                    end
                end
...
spawn(function()
    while task.wait() do
        if _G.Aimbot_arma and game:GetService("Players").LocalPlayer.Character:FindFirstChild(SelecionarWeaponarma) then
            pcall(function()
                game:GetService("Players").LocalPlayer.Character[SelecionarWeaponarma].Cooldown.Value = 0
                local args = {
                    [1] = game:GetService("Players"):FindFirstChild(PlayerSelecionarAimbot).Character.HumanoidRootPart.Position,
                    [2] = game:GetService("Players"):FindFirstChild(PlayerSelecionarAimbot).Character.HumanoidRootPart
                }
                game:GetService("Players").LocalPlayer.Character[SelecionarWeaponarma].RemoteFunctionShoot:InvokeServer(unpack(args))
                game:GetService'VirtualUser':CaptureController()
                game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
...
spawn(function()
    pcall(function()
        while task.wait() do
            if _G.Aimbot_Skill and PlayerSelecionarAimbot ~= nil and game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool") and game.Players.LocalPlayer.Character[game.Players.LocalPlayer.Character:FindFirstChildOfClass("Tool").Name]:FindFirstChild("MousePos") then
                local args = {
                    [1] = game:GetService("Players"):FindFirstChild(PlayerSelecionarAimbot).Character.HumanoidRootPart.Position
                }
...
spawn(function()
	while wait() do
	if Mundo3 and _G.AutoPullLever and not dagatcanmemay and IsMirageIlha2() then
	if CheckSea(3) then
		...
		if Valk and MirrorFractal then
			local cz = game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaçaV4Progress", "Check")
			if cz == 1 then
				game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaçaV4Progress", "Begin")
			elseif cz == 2 then
				TweenTempleLegit()
			elseif cz == 3 then
				game.ReplicatedStorage.Remotes.CommF_:InvokeServer("RaçaV4Progress", "Continue")
			elseif
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoRaça then
                if game.Players.LocalPlayer.Character.RaçaTransformed.Value == true then
                    StardFarm = false
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoRaça then
                if game.Players.LocalPlayer.Character.RaçaTransformed.Value == false then
                    StardFarm = true
                end
            end
        end
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.AutoQuestRaça then
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                if game:GetService("Players").LocalPlayer.Data.Raça.Value == "Human" then
                    for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            pcall(function()
                                repeat wait(.1)
                                    ...
                                    v.HumanoidRootPart.CanCollide = false
                                    sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
                                until not _G.AutoQuestRaça or not v.Parent or v.Humanoid.Health <= 0
                            end)
                        end
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Skypiea" then
                    for i,v in pairs(game:GetService("Workspace").Map.SkyTrial.Model:GetDescendants()) do
                        if v.Name ==  "snowIlha_Cylinder.081" then
                            topos(v.CFrame* CFrame.new(0,0,0))
                        end
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Raça.Value == "Fishman" then
                    for i,v in pairs(game:GetService("Workspace").Fera do Mars.Fera do Mar1:GetDescendants()) do
                        if v.Name ==  "HumanoidRootPart" then
                            topos(v.CFrame* Pos)
                            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
                                    if v.ToolTip == "Soco" then -- "Blox Fruta" , "Espada" , "Wear" , "Agility"
                            ...
                            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
                                    if v.ToolTip == "Blox Fruta" then -- "Blox Fruta" , "Espada" , "Wear" , "Agility"
                                        game.Players.LocalPlayer.Character.Humanoid:EquipTool(v)
                                    end
                                end
                            end
                            ...
                            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
                                    if v.ToolTip == "Espada" then -- "Blox Fruta" , "Espada" , "Wear" , "Agility"
                                        game.Players.LocalPlayer.Character.Humanoid:EquipTool(v)
                                    end
                                end
                            end
                            ...
                            for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
                                if v:IsA("Tool") then
                                    if v.ToolTip == "arma" then -- "Blox Fruta" , "Espada" , "Wear" , "Agility"
                                        game.Players.LocalPlayer.Character.Humanoid:EquipTool(v)
                                    end
                                end
                            end
...
plySelecionarhunthelpold = v.Humanoid.Health
repeat task.wait()
NameTarget = v.Name
AutoHaki()
EquipWeapon(_G.SelecionarWeapon)
...
v.HumanoidRootPart.CanCollide = false
TargetSelecionarHunt = v.Humanoid
until KillPlayer == false or v.Humanoid.Health == 0 or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Humanoid") or not v.Parent or NextplySelecionar == true
NextplySelecionar = false
...
spawn(function()
    ...
    spawn(function()
        ...
        if _G.Hopfinddao then
            if game:GetService("Workspace").Map:FindFirstChild("MysticIlha") or game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
            ...
            elseif not game:GetService("Workspace").Map:FindFirstChild("MysticIlha") or not game:GetService("Workspace").Map:FindFirstChild("MysticIlha") then
                Hop()
                end
            end
        end
...
OrionLib:MakeNotification({
        Name = "Script Portugues Hub",
        Content = "Loading script Completo!, You can now enable the function!",
        Image = "rbxassetid://119980140458596",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "Script Portugues Hub",
    Content = "Loading Config Completo!!",
    Image = "rbxassetid://119980140458596",
    Time = 5
})
